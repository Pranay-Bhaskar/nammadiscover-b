...
exports.createLocation = async (req, res) => {
    try {
        ...
        const formattedName =
            typeof name === 'string' ? { en: name, kn: '' } : name;
        ...
        const formattedCulturalStory =
            typeof culturalStory === 'string'
                ? { en: culturalStory, kn: '' }
                : (culturalStory || { en: '', kn: '' });

        const formattedTravelTips =
        ...
        const location = new Location({
            ...
            description: formattedDesc,
            culturalStory: formattedCulturalStory,
            ...
            isFamilyRun: !!isFamilyRun,
            authenticityScore: Number(authenticityScore) || 80,
            verifiedLocal: !!verifiedLocal,
            isVerified: true,
